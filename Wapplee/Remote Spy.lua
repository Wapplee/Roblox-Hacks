...
local LoadToExe = Instance.new("TextButton")
...
local RemoteExecuteButton = Instance.new("TextButton")
...
local hiding = false
local defaultbgsize = UDim2.new(.6, -300, .6, -200)
...
RemoteSpy.Name = "RemoteSpy ID:"..math.random(1,99999999)
RemoteSpy.Parent = game.CoreGui
RemoteSpy.ResetOnSpawn = false

-- Customization ---- Customization ---- Customization ---- Customization ---- Customization ---- Customization --
local gradientmultiply = .7
local uicolor = Color3.new(.7, .2, .3)
local sidebuttons = Color3.new(1, 0, .5)
local titlename = "R2S Revamp"
local titlecolor = Color3.new(1, .2, .3)

BG.Name = "BG"
BG.Parent = RemoteSpy
BG.Active = true
BG.BackgroundColor3 = uicolor
BG.BorderColor3 = Color3.new(0.243137, 0.243137, 0.243137)
BG.Draggable = true
BG.Position = UDim2.new(0.5, -700, 0.5, -400)
BG.Size = defaultbgsize
BG.ClipsDescendants = true

Ribbon.Name = "Ribbon"
Ribbon.Parent = BG
Ribbon.BackgroundColor3 = BG.BackgroundColor3
...
LoadToExe.Name = "LoadToExe"
LoadToExe.Parent = ButtonsFrame
LoadToExe.BackgroundColor3 = Color3.new(0.0784314, 0.0784314, 0.0784314)
LoadToExe.BorderColor3 = Color3.new(0.384314, 0.384314, 0.384314)
LoadToExe.Position = UDim2.new(0, 120, 0.5, -10)
LoadToExe.Size = UDim2.new(0, 100, 0, 20)
LoadToExe.ZIndex = 3
LoadToExe.Font = Enum.Font.SourceSansBold
LoadToExe.FontSize = Enum.FontSize.Size14
LoadToExe.Text = "LOAD TO EXE"
LoadToExe.TextColor3 = Color3.new(0.784314, 0.784314, 0.784314)
LoadToExe.TextSize = 14
...
RemoteExecuteButton.Name = "Execute"
RemoteExecuteButton.Parent = ButtonsFrame
RemoteExecuteButton.BackgroundColor3 = Color3.new(0.0784314, 0.0784314, 0.0784314)
RemoteExecuteButton.BorderColor3 = Color3.new(0.384314, 0.384314, 0.384314)
RemoteExecuteButton.Position = UDim2.new(1,-220,.25,0)
RemoteExecuteButton.Size = UDim2.new(0, 100, 0, 20)
RemoteExecuteButton.ZIndex = 3
RemoteExecuteButton.Font = Enum.Font.SourceSansBold
RemoteExecuteButton.FontSize = Enum.FontSize.Size14
RemoteExecuteButton.Text = "EXECUTE REMOTE"
RemoteExecuteButton.TextColor3 = Color3.new(0.784314, 0.784314, 0.784314)
RemoteExecuteButton.TextSize = 14
...
RemoteName.BackgroundColor3 = BG.BackgroundColor3
...
local cWR = BG.BackgroundColor3
ID.Name = "ID"
ID.Parent = RBTN
ID.BackgroundColor3 = Color3.new(cWR.R*gradientmultiply,cWR.G*gradientmultiply,cWR.B*gradientmultiply)
...
FullScreen.BackgroundColor3 = sidebuttons
...
Hide.Name = "Hide"
Hide.Parent = Ribbon
Hide.BackgroundColor3 = sidebuttons
Hide.BorderSizePixel = 0
Hide.Position = UDim2.new(1, -140, 0, 0)
...
StopScript.Parent = Ribbon
StopScript.BackgroundColor3 = sidebuttons
StopScript.BorderSizePixel = 0
StopScript.Position = UDim2.new(1, -40, 0, 0)
StopScript.Size = UDim2.new(0, 40, 0, 20)
StopScript.ZIndex = 3
StopScript.Font = Enum.Font.SourceSansBold
StopScript.FontSize = Enum.FontSize.Size14
StopScript.Text = "X"
StopScript.TextColor3 = Color3.new(1, 1, 1)
StopScript.TextSize = 14
...
local onclick_hide = function()
	Hide.Text = hiding == false and hide() or show()
	hiding = not hiding
end
...
local onclick_fullscreen = function(a)
    fullscreen = not fullscreen
	if fullscreen == false then
	    size_pos_frame(BG, UDim2.new(.6, -300, .6, -200), UDim2.new(0, 0, 0, -40))
	    BG.Draggable = true
    else
...
StopScript.MouseButton1Down:Connect(stopscript)
...
RemoteExecuteButton.MouseButton1Down:Connect(executescript)
...
local dump_script = function(script,stop)
...
LoadToExe.MouseButton1Down:Connect(function()
	dump_script('bro u gay?\nwhat')
end)
